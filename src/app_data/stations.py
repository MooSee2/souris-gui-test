...
met_station_names = [
    ...
    {"name": ["Roughbark", "Wind Speed", "m/s"], "id": "1234_wind_speed", "type": "numeric"},
    {"name": ["Roughbark", "Wind Speed", "m/s"], "id": "1234_wind_speed_approval"},
    {"name": ["Roughbark", "Air Temperature", "C"], "id": "1234_air_temp", "type": "numeric"},
    {"name": ["Roughbark", "Air Temperature", "C"], "id": "1234_air_temp_approval"},
    {"name": ["Roughbark", "Solar Radiation", "w/m\u00b2"], "id": "1234_sol_rad", "type": "numeric"},
    {"name": ["Roughbark", "Solar Radiation", "w/m\u00b2"], "id": "1234_sol_rad_approval"},
    {"name": ["Roughbark", "Relative Humidity", "%"], "id": "1234_rel_humidity", "type": "numeric"},
    {"name": ["Roughbark", "Relative Humidity", "%"], "id": "1234_rel_humidity_approval"},
    {"name": ["Roughbark", "Precipitation", "mm"], "id": "1234_precip", "type": "numeric"},
    {"name": ["Roughbark", "Precipitation", "mm"], "id": "1234_precip_approval"},
    {"name": ["Handsworth", "Wind Speed", "m/s"], "id": "4321_wind_speed", "type": "numeric"},
    {"name": ["Handsworth", "Wind Speed", "m/s"], "id": "4321_wind_speed_approval"},
    {"name": ["Handsworth", "Air Temperature", "C"], "id": "4321_air_temp", "type": "numeric"},
    {"name": ["Handsworth", "Air Temperature", "C"], "id": "4321_air_temp_approval"},
    {"name": ["Handsworth", "Solar Radiation", "w/m\u00b2"], "id": "4321_sol_rad", "type": "numeric"},
    {"name": ["Handsworth", "Solar Radiation", "w/m\u00b2"], "id": "4321_sol_rad_approval"},
    {"name": ["Handsworth", "Relative Humidity", "%"], "id": "4321_rel_humidity", "type": "numeric"},
    {"name": ["Handsworth", "Relative Humidity", "%"], "id": "4321_rel_humidity_approval"},
    {"name": ["Handsworth", "Precipitation", "mm"], "id": "4321_precip", "type": "numeric"},
    {"name": ["Handsworth", "Precipitation", "mm"], "id": "4321_precip_approval"},
]
